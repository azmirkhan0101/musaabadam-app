            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  //===================GRAPHICS=========================//
                  ImageWidget(width: 240, height: 227, imagePath: Assets.images.newPasswordOnboarding.keyName
                  ),
                  SizedBox(height: 15),
                  TextWidget(text: AppStrings.setNewPassword.tr,
                    fontColor: AppColors.black50Percent,
                    figmaLetterSpacing: -2,
                    fontWeight: FontWeight.w700,
                  ),
                  SizedBoxWidget(height: 8,),
                  TextWidget(text: AppStrings.yourNewPassword.tr,
                  ...
                  //===================CONTINUE BUTTON=========================//
                  ButtonWidget(label: AppStrings.resetPassword.tr,
                  fontWeight: FontWeight.w700,
