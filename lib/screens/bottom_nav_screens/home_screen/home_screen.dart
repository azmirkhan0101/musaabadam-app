    ...
    return SingleChildScrollView(
      ...
      child: Row(
        children: [
          ...
          CategoryItem(height: 93, width: 96, imageHeight: 65, imageWidth: 88, imagePath: Assets.images.circleOrange.keyName, itemName: AppStrings.forYou),
          CategoryItem(height: 93, width: 96, imageHeight: 65, imageWidth: 88, imagePath: Assets.images.arrowOrange.keyName, itemName: AppStrings.followedHosts),
